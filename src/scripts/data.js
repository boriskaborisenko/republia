var data = {
    content:[
        ...
        {docs:[
            {onepager:'https://media.republia.io/republia-one-pager-en.pdf'},
            {overview:'https://media.republia.io/republia-overview-en.pdf'},
            {whitepaper:'https://media.republia.io/republia-whitepaper-en.pdf'},
            {techpaper:'https://media.republia.io/republia-techpaper-en.pdf'},
            {finmodel:'https://docs.google.com/spreadsheets/d/1fqPKNz3uokD4sCHAZfRC3Gt2MlfqXEVxjoLVx5GWMEw/edit'},
            {techcompetitive :'https://media.republia.io/republia-tech-comp-en.pdf'},
            {ecosys:'https://media.republia.io/republia-tech-comp-en.pdf'},
            {policy:'https://media.republia.io/republia-tech-comp-en.pdf'}
        ]}
    ]
